...
args = {
    'exp_name': 'voc-rwn',
    'snapshot': 'epoch_33_loss_0.31766_acc_0.745188_acc-cls_0.81110_mean-iu_0.68271_fwavacc_0.74757_lr_0.0023769346.pth'
}
...
def main():
    net = rwn(num_classes=voc.num_classes).cuda()
